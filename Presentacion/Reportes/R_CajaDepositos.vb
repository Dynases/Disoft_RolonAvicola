...
Public Class R_CajaDepositos
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Presentacion.R_CajaDepositos.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedR_CajaDepositos
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As R_CajaDepositos = New R_CajaDepositos()
        rpt.Site = Me.Site
        Return rpt
    End Function
