...
Public Class R_CajaCortes
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Presentacion.R_CajaCortes.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedR_CajaCortes
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As R_CajaCortes = New R_CajaCortes()
        rpt.Site = Me.Site
        Return rpt
    End Function
