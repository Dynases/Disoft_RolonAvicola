...
Public Class R_FacturaPreImpresa1
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "R_FacturaPreImpresa1.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Presentacion.R_FacturaPreImpresa1.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_Ley() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedR_FacturaPreImpresa1
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As R_FacturaPreImpresa1 = New R_FacturaPreImpresa1()
        rpt.Site = Me.Site
        Return rpt
    End Function
