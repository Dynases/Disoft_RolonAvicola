...
#Region "METODOS PRIVADOS"
    ...
    Private Sub P_ArmarDatos()
        ...
        If (Not IsDBNull(Dt2EstadoTotal.Compute("Sum(Importe)", "numicli = " + tbCodigoCliente.Text + " and concepto = 1"))) Then
            ingT = Dt2EstadoTotal.Compute("Sum(Importe)", "numicli = " + tbCodigoCliente.Text + " and concepto = 1")
        End If
        If (Not IsDBNull(Dt2EstadoTotal.Compute("Sum(Pagos)", "numicli = " + tbCodigoCliente.Text + " and concepto = 2"))) Then
            salT = Dt2EstadoTotal.Compute("Sum(Pagos)", "numicli = " + tbCodigoCliente.Text + " and concepto = 2")
        End If
        ...
        'Sumar Importe
        ing = IIf(IsDBNull(Dt1Estado.Compute("Sum(Importe)", "numicli = " + tbCodigoCliente.Text + " and concepto = 1")), 0, Dt1Estado.Compute("Sum(Importe)", "numicli = " + tbCodigoCliente.Text + " and concepto = 1"))
        'Sumar Pagos
        sal = IIf(IsDBNull(Dt1Estado.Compute("Sum(Pagos)", "numicli = " + tbCodigoCliente.Text + " and concepto = 2")), 0, Dt1Estado.Compute("Sum(Pagos)", "numicli = " + tbCodigoCliente.Text + " and concepto = 2"))
